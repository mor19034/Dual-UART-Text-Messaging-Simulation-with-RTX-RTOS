 ...
 * statements. This allows the use of uart functions into different cases 
 * swithcing only using the UART ID
 *---------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
  SendText1/2/3 - send a null-terminated string out the given UART
	This function receives a pointer to a text string and parses the
...
/*----------------------------------------------------------------------------
  ...
  To let the user know from who did he got the message
 *---------------------------------------------------------------------------*/
